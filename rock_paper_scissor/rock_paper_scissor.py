...
def view_score():
    u_score=Label(text="Your Score : "+ user_score)
    u_score.grid(row=3,cloumn=2)
    s_score=Label(text="Your Score : "+ system_score)
    s_score.grid(row=3,cloumn=2)
...
def game():
    ...
    veiw_score=Button(top,text="View Score",command=view_score)
    view_score.grid(row=2,column=2)
